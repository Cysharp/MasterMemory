...
namespace MasterMemory
{
    ...
    public struct MemoryKey<T1> : IMemoryKey, IEquatable<MemoryKey<T1>>
    {
        T1 item1;
    ...
    public struct MemoryKey<T1, T2> : IMemoryKey, IEquatable<MemoryKey<T1, T2>>
    {
        T1 item1;
        T2 item2;
    ...
    public struct MemoryKey<T1, T2, T3> : IMemoryKey, IEquatable<MemoryKey<T1, T2, T3>>
    {
        T1 item1;
        T2 item2;
        T3 item3;
    ...
    public struct MemoryKey<T1, T2, T3, T4> : IMemoryKey, IEquatable<MemoryKey<T1, T2, T3, T4>>
    {
        T1 item1;
        T2 item2;
        T3 item3;
    ...
    public struct MemoryKey<T1, T2, T3, T4, T5> : IMemoryKey, IEquatable<MemoryKey<T1, T2, T3, T4, T5>>
    {
        T1 item1;
        T2 item2;
        T3 item3;
    ...
    public struct MemoryKey<T1, T2, T3, T4, T5, T6> : IMemoryKey, IEquatable<MemoryKey<T1, T2, T3, T4, T5, T6>>
    {
        T1 item1;
        T2 item2;
        T3 item3;
    ...
    public struct MemoryKey<T1, T2, T3, T4, T5, T6, T7> : IMemoryKey, IEquatable<MemoryKey<T1, T2, T3, T4, T5, T6, T7>>
    {
        T1 item1;
        T2 item2;
        T3 item3;
